...
export type MutationResolvers<Context = any, ParentType = ResolversTypes['Mutation']> = {
  ...
  createRepo?: Resolver<Maybe<ResolversTypes['Repo']>, ParentType, Context, MutationCreateRepoArgs>,
...
export type QueryResolvers<Context = any, ParentType = ResolversTypes['Query']> = {
  ...
  listFiles?: Resolver<ResolversTypes['ModelFileConnection'], ParentType, Context, QueryListFilesArgs>,
  readImage?: Resolver<Maybe<ResolversTypes['File']>, ParentType, Context, QueryReadImageArgs>,
  listImages?: Resolver<ResolversTypes['ModelFileConnection'], ParentType, Context, QueryListImagesArgs>,
  readRepo?: Resolver<Maybe<ResolversTypes['Repo']>, ParentType, Context, QueryReadRepoArgs>,
  listRepos?: Resolver<ResolversTypes['ModelRepoConnection'], ParentType, Context>,
